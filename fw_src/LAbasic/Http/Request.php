<?php 
/*
My projects use many functions of the request of Laravel, but I do not want to modify the absent funcitons every where.
This is just a copy of Illuminate\Http\Request.php.
If include "illuminate/http": "5.0.*" in composer.json, 
many other classes and dependencies will be pulled, such as symfony/http-kernel, and the size of vendor will increases abou 1MB.
*/
namespace LAbasic\Http;
